...
for obj = 1:length(stats)
     ...
     if ~isempty(bbox)
         ...
         distance_center_px = [obj_size_px(1)-frame_middle(1), frame_middle(2)-obj_size_px(2)]
         ...
         %                      z                   
         robot.move_c(ee_pose(1),ee_pose(2),ee_pose(3),0); % check xyz coordinates with robot.draw()
